...
$q = "select * from all_data where category_id=5";
    ...
    <div class="row">
        ...
        <div class="col-md-4" style="margin-left:250px;MARGIN-BOTTOM:5PX;">
            ...
            <h3><a data="page_0" class="model_form btn btn-sm btn-danger" href="#"><span
                        class="glyphicon glyphicon-plus"></span> Add new others</a></h3>
        </div>
    </div>
    <div class="row">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="icon-paragraph-justify2"></i><span id="pop_title">Add</span> others
                    information</h4>
            </div>
            <!-- Form inside modal -->
            <form method="post" action="add_others.php" id="cat_form">
