...
if (isset($_POST['form_data'])) :
    ...
    $sql1 = "update datas set balance_amount='$new_bal',approval_amount='$new_app' where category_id=1 and number='$user_number'";
    $res1 = mysqli_query($con, $sql1);

    $sql = "INSERT INTO `approval` (`category_id`,`number`, `approval_date`,`approval_amount`) VALUES (1,'$user_number' , '$user_approval_date', '$user_approval_amount')";
    $con = mysqli_connect('localhost', 'root', '');
    mysqli_select_db($con, 'c-dot');
...
echo "<script>window.location = 'approval_patent.php?no=$user_number'</script>";
...
if (isset($_POST['ct_data_id'])) :
    ...
    if ($data_id != "") :
        ...
        $sql2 = "select * from approval where category_id=1 and number='$number' and approval_id='$data_id'";
        ...
        echo '<script> console.log($old_inv , $new_bal);</script>';
            ...
            $q1 = "update datas set approval_amount='$new_apr' where number='$number' and category_id=1";
