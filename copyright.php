...
$q = "select * from all_data where category_id=4";
    ...
    <div class="row">
        ...
        <div class="col-md-4" style="margin-left:250px;MARGIN-BOTTOM:5PX;">
            ...
            <h3><a data="page_0" class="model_form btn btn-sm btn-danger" href="#"><span
                        class="glyphicon glyphicon-plus"></span> Add new copyright</a></h3>
        </div>
    </div>
    <div class="row">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="icon-paragraph-justify2"></i><span id="pop_title">Add</span> copyright
                    information</h4>
            </div>
            <!-- Form inside modal -->
            <form method="post" action="add_copyright.php" id="cat_form">
